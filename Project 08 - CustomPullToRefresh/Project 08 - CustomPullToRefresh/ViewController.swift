...
//  Project 08 - CustomPullToRefresh
//
//  Created by 陈炯 on 16/7/6.
            ...
            for i in 0 ..< self.labelsArray.count {
                ...
                UIView.animate(withDuration: 0.25, delay: 0.0, options: UIViewAnimationOptions.curveLinear, animations: { () -> Void in
                    ...
                    for j in 0..<13 {
                        ...
                        self.labelsArray[13 - j].transform = CGAffineTransform.identity
    ...
    func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        if refreshController.isRefreshing {
            if !isAnimating {
                ...
                timer = Timer.scheduledTimer(timeInterval: 5.6, target: self, selector: #selector(ViewController.stopAnimation), userInfo: nil, repeats: true)
